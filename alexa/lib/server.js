  ...
  try {
    ...
    switch (requestedNamespace) {
      ...
      case NAMESPACE_DISCOVERY:
        response = handleDiscovery2.bind(this)(event);
        break;
...
var handleDiscovery2 = function(event) {
  var response = null;
...
var handleControlSetColor = function(event) {
  ...
  if( device.mappings.Brightntess )
    device.command( device.mappings.Brightntess, target_brightness );
